    ...
    <div class="login-content">
        <div class="widget-content" style="padding-bottom:0;">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="no-margin" id="change-form">
                <h3 style="color: white;">管理员更改密码</h3>
                <fieldset>
                    <div class="form-group no-margin">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="password" placeholder="请输入旧密码" class="form-control input-lg" id="old" name="old">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="password" placeholder="请输入新密码" class="form-control input-lg" id="new" name="new">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="password" placeholder="请确认新密码" class="form-control input-lg" id="new1" name="new1">
                        </div>
                    </div>
                </fieldset>
